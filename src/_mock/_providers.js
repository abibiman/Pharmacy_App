...
export const Providers_STATUS_OPTIONS = [
...
export const _providersFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _providersPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _providersInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
...
export const _providersList = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  zipCode: '85807',
  state: 'Virginia',
  city: 'Rancho Cordova',
