...
const blog = [
  {
    id: 1,
    title: 'The Importance of Regular Health Check-ups in a Digital Age',
    desc: '',
    image:
      'https://d2jx2rerrg6sh3.cloudfront.net/images/Article_Images/ImageForArticle_10801_16623491270287278.jpg',
  },
  {
    id: 2,
    title: 'Telehealth: The Future of Convenient Care',
    desc: '',
    image: 'https://i.ibb.co/Y2VcDCR/blog-illus.jpg',
  },

  {
    id: 3,
    title: 'Telehealth and Seniors: Bridging the Digital Divide',
    image: 'https://www.apaservices.org/images/article-telehealth-older-adults_tcm9-277465.jpg',
  },
];
...
export const _appointments = appointments.map((item) => ({
  id: item.id,
...
export const _appFeatured = blog.map((item) => ({
  id: item.id,
  title: item.title,
