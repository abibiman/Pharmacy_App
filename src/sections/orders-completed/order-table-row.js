...
export default function OrderTableRow({ row, selected, onViewRow, onSelectRow, onDeleteRow }) {
  const {price, providerID, userID, patient, patientContact, patientEmail, providerTitle, providerName, facilityID, datePrescribed, statusDescription, pharmacy, medications,orderNumber,status } = row;
