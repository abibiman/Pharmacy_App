  ...
  return (
    <Container component={MotionViewport} sx={{ textAlign: 'center', py: { xs: 10, md: 15 } }}>
      ...
      <m.div variants={varFade().inUp}>
        ...
        >
          Telical Healthcare offers dedicated support for any concerns. Our responsive support team
          ensures a prompt response within a day.Your well-being is our priority.
        </Typography>
      </m.div>
