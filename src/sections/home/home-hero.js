...
const StyledTextGradient = styled(m.h1)(({ theme }) => ({
  ...textGradient(
    `300deg,  ${theme.palette.primary.main} 0%, #2065d1 25%, #6986c5 50%, ${theme.palette.primary.main} 75%, #2065d1 100%`
  ),
  padding: 0,
  marginTop: 8,
  lineHeight: 1,
    ...
    >
      ...
      <m.div variants={varFade().in}>
        <Typography variant="body2" sx={{ textAlign: 'center' }}>
          Empower your health journey with real-time insights, seamlessly integrating advanced
          devices and expert care—all from the comfort of home.
        </Typography>
      </m.div>
        ...
        <Stack spacing={2} direction="row" justifyContent="center">
          {['ios', 'android', 'web'].map((platform) => (
            <m.div key={platform} variants={varFade().in}>
              <Box
                component="img"
                src={`/assets/icons/platforms/${platform}.png`}
        ...
        <Box
          ...
          src={
            isLight
              ...
              : `/assets/images/home/hero/dark-min.webp`
          }
