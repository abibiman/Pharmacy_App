  ...
  const renderDescription = (
    ...
    >
      ...
      <m.div variants={varFade().inUp}>
        ...
        Our primary objective is to refine and elevate healthcare across every level. We achieve this by seamlessly integrating modern 
        technology with data science, ensuring that every individual receives the most advanced and personalized care available.
        </Typography>
      </m.div>
...
function TestimonialCard({ testimonial, sx, ...other }) {
  ...
  const { name, postedDate, content, avatarUrl } = testimonial;
