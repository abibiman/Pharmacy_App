...
//
import JobDetailsToolbar from '../providers-details-toolbar';
import JobDetailsContent from '../providers-details-content';
import JobDetailsCandidates from '../providers-details-candidates';

// ----------------------------------------------------------------------

export default function ProvidersDetailsView({ id }) {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <JobDetailsToolbar
        backLink={paths.dashboard.providers.root}
        editLink={paths.dashboard.providers.edit(`${currentJob?.id}`)}
        liveLink="#"
        publish={publish || ''}
...
ProvidersDetailsView.propTypes = {
  id: PropTypes.string,
};
