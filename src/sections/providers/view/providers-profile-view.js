...
export default function ProvidersProfileView() {
  ...
  const [appointmentTimeInput, setAppointmentTimeInput] = useState('Time');
  const [appointmentTypeInput, setAppointmentTypeInput] = useState('Audio');
  ...
  const handleSubmitAppointment = async () => {
    ...
    try {
      ...
      if (submittedData) {
        enqueueSnackbar('Appointment successfully booked');
      }
    } catch (error) {
      console.log(error);
    }
    ...
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        ...
        links={[
          ...
          { name: 'Providers', href: paths.dashboard.providers.collection },
