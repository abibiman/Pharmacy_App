...
//
import InvoiceNewEditDetails from './appointment-new-edit-details';
import InvoiceNewEditAddress from './appointment-new-edit-address';
import InvoiceNewEditStatusDate from './appointment-new-edit-status-date';

// ----------------------------------------------------------------------

export default function AppointmentNewEditForm({ currentInvoice }) {
